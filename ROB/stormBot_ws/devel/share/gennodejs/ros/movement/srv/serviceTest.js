...
class serviceTestRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type serviceTestRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type serviceTestRequest
    let len;
    let data = new serviceTestRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new serviceTestRequest(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class serviceTestResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type serviceTestResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type serviceTestResponse
    let len;
    let data = new serviceTestResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new serviceTestResponse(null);
...
module.exports = {
  ...
  datatype() { return 'movement/serviceTest'; }
};
