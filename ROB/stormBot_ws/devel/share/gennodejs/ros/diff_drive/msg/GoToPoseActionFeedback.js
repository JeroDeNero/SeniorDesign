...
class GoToPoseActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GoToPoseFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GoToPoseActionFeedback(null);
    ...
    data.feedback = GoToPoseFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GoToPoseActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = GoToPoseFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new GoToPoseFeedback()
    }
...
module.exports = GoToPoseActionFeedback;
