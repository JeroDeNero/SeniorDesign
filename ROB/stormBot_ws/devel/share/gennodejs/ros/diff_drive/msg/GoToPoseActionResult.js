...
class GoToPoseActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GoToPoseResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GoToPoseActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = GoToPoseResult.Resolve(msg.result)
    }
    else {
      resolved.result = new GoToPoseResult()
    }
...
module.exports = GoToPoseActionResult;
