...
#include <stddef.h>
#include "teleop_tools_msgs/action/increment__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_SendGoal_service_members = {
  "teleop_tools_msgs__action",  // service namespace
  "Increment_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_SendGoal_service_type_support_handle = {
  0,
  &teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, teleop_tools_msgs, action, Increment_SendGoal)() {
  if (!teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_SendGoal_service_type_support_handle.typesupport_identifier) {
    teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_SendGoal_service_type_support_handle.data;
  ...
  return &teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_SendGoal_service_type_support_handle;
}
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_GetResult_service_members = {
  "teleop_tools_msgs__action",  // service namespace
  "Increment_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_GetResult_service_type_support_handle = {
  0,
  &teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, teleop_tools_msgs, action, Increment_GetResult)() {
  if (!teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_GetResult_service_type_support_handle.typesupport_identifier) {
    teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_GetResult_service_type_support_handle.data;
  ...
  return &teleop_tools_msgs__action__increment__rosidl_typesupport_introspection_c__Increment_GetResult_service_type_support_handle;
}
