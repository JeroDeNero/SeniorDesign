...
#ifndef TELEOP_TOOLS_MSGS__ACTION__INCREMENT__STRUCT_H_
#define TELEOP_TOOLS_MSGS__ACTION__INCREMENT__STRUCT_H_
...
{
  rosidl_generator_c__float__Sequence increment_by;
...
#endif  // TELEOP_TOOLS_MSGS__ACTION__INCREMENT__STRUCT_H_
